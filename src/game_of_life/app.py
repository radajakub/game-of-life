...
from game_of_life.gui.config import INTRO_SCREEN_LABEL, CREATE_PATTERN_SCREEN_LABEL, SIMULATION_SCREEN_LABEL
from game_of_life.gui.run_simulation import SimulationScreen
